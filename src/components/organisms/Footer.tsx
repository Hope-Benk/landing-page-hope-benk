				...
				<div className="grid md:grid-cols-4 gap-12">
					<div className="col-span-1">
						...
						<p className="text-sm text-on-surface-variant mb-6 font-body leading-relaxed">
							Transformando o acesso ao crédito para impulsionar a economia
							real através de tecnologia e empatia.
						</p>
					...
					<div>
						<h4 className="font-bold text-on-surface mb-6 font-body">Empresa</h4>
					...
					<div>
						<h4 className="font-bold text-on-surface mb-6 font-body">
							Legal &amp; Suporte
						</h4>
						<ul className="space-y-4 text-sm font-body">
							<li>
					...
					<div className="bg-primary/5 p-6 rounded-3xl border border-primary/10">
						<h4 className="font-bold text-primary mb-4 font-body">
