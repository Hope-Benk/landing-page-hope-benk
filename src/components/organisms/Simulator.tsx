...
export default function Simulator() {
  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 bg-surface-container-low" id="simulator">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 bg-surface-container-lowest p-6 md:p-10 rounded-4xl shadow-sm border border-outline-variant/10">
            <div className="space-y-10 md:space-y-12">
              {/* Amount Slider */}
              <div className="space-y-6">
                <div className="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-end font-body">
                  <label className="text-on-surface-variant font-semibold text-xs sm:text-sm uppercase tracking-wider">
                    Valor desejado
                  </label>
          ...
          {/* Right card: Simulation Summary */}
          <div className="lg:col-span-2 bg-primary p-6 md:p-10 rounded-4xl text-white flex flex-col justify-between shadow-xl">
            <div>
              <p className="text-blue-100 font-medium mb-2 font-body text-sm">
                Estimativa da parcela
              </p>
              <h3 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-8 font-display">
                {formatCurrency(pmt)}
              </h3>
            ...
            <div className="mt-10 md:mt-12 space-y-4">
              ...
              />
              <Button variant="simulator-action" onClick={handleWhatsAppClick}>
                Solicitar Agora
              </Button>
            </div>
          </div>
